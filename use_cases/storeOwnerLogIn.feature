...
Scenario: successful log in with valid credentials
 ...
 Given the StoreOwner is on the log in page
 When the StoreOwner enter invalid username "malik1" and password "1234"
 And the StoreOwner click in loginQ	
 Then invalid StoreOwner message disply
 
 
 Scenario: unsuccessful log in with invalid password
 Given the StoreOwner is on the log in page
 When the StoreOwner enter username "malik" and invalid password "123456"
 And the StoreOwner click in loginB
